...
int main() {
    ...
    while (true) {
      ...
      //  if (gpio_get(QTPY_BOOT_PIN)) { // poll every cycle, 0 = "pressed"
        ...
        sleep_ms(10000); // don't DDOS the serial console
    }
    return 0;
}                  
